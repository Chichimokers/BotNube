...
class Freeapi():
    ...
    def login(self):
        ...
        respuesta = self.Session.post(url="http://"+self.host+"/index.php/ped/login/signIn",data=data)
    ...
    def getarticleId(self):
        ...
        respano =  self.Session.post("http://"+self.host+"/index.php/ped/author/saveSubmit/1",data=data)
    ...
    def upload_file(self,filepath):
           ...
           paso2 = self.Session.post(url="http://"+self.host+"/index.php/ped/au+thor/saveSubmit/"+submitnumber,data=f,headers=cabeceras)
           ...
           paso3 = self.Session.post(url="http://"+self.host+"/index.php/ped/author/saveSubmit/"+str(int(submitnumber)+1),data=datas)
           ...
           finalizar = self.Session.post(url="http://"+self.host+"/index.php/ped/author/saveSubmit/"+finalnumber[len(finalnumber)-1],data=datosfinal)
