...
class Freeapi():
    ...
    def login(self):
        ...
        respuesta = self.Session.post(url="http://www.rcics.sld.cu/index.php/acimed/login/signIn",data=data)
    ...
    def getarticleId(self):
        ...
        respano =  self.Session.post(url="http://www.rcics.sld.cu/index.php/acimed/author/saveSubmit/1",data=data)
    ...
    def upload_file(self,filepath):
           ...
           paso2 = self.Session.post(url="http://www.rcics.sld.cu/index.php/acimed/author/saveSubmit/"+submitnumber,data=f,headers=cabeceras)
           ...
           paso3 = self.Session.post(url="http://www.rcics.sld.cu/index.php/acimed/author/saveSubmit/"+str(int(submitnumber)+1),data=datas)
           ...
           finalizar = self.Session.post(url="http://www.rcics.sld.cu/index.php/acimed/author/saveSubmit/"+finalnumber[len(finalnumber)-1],data=datosfinal)
